...
pub const Converter = struct {
    to_json: *const fn (value: *anyopaque, allocator: std.mem.Allocator) anyerror!std.json.Value,
    from_json: *const fn (json: std.json.Value, allocator: std.mem.Allocator) anyerror!*anyopaque,
